      ...
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ Hi! I'm TheRealBox. I play video games and enjoy playing tennis, and am an experienced Discord app developer! I made this bot with some code from a YouTuber, so I linked his social with the /help command!`)
            .setTimestamp();
